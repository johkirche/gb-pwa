        ...
        <div class="container mx-auto">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <Button v-if="showBackButton" variant="outline" size="sm" @click="handleBack">
                        <ArrowLeft class="w-4 h-4 mr-2" />
                        {{ backButtonText }}
                    </Button>

                    <!-- Home button (when not on home page) -->
                    <Button v-if="showHomeButton" variant="outline" size="sm" @click="navigateTo('/home')">
                        <Home class="w-4 h-4 mr-2" />
                        Home
                    </Button>

                    <!-- Logout button (when on home page) -->
                    <Button v-if="showLogoutButton" variant="destructive" size="sm" @click="handleLogout">
