<template>
    <Card class="mt-8">
        ...
        <CardContent>
            <div class="flex flex-col space-y-4"> <!-- Browse Songs Button -->
                <Button class="w-fit" @click="navigateTo('/lieder')">
                ...
                <div class="border-t pt-4">
                    ...
                    <Button class="w-fit" variant="outline" size="sm" :disabled="isLoading"
