    ...
    <Card>
        ...
        <CardContent class="space-y-4">
            ...
            <div v-if="lied.externerLink" class="space-y-1">
                ...
                <a :href="lied.externerLink" target="_blank" rel="noopener noreferrer"
            ...
            <div v-if="lied.linkCloud" class="space-y-1">
                ...
                <a :href="lied.linkCloud" target="_blank" rel="noopener noreferrer"
                    class="text-sm text-primary hover:underline flex items-center">
                    View in Cloud
            ...
            <!-- Status Indicators -->
            <div class="space-y-2">
                <div v-if="lied.liedHatAenderung" class="flex items-center text-orange-600">
                ...
                <div v-if="lied.melodieGeaendert" class="flex items-center text-purple-600">
            ...
            <div v-if="lied.rueckfrageAutor" class="space-y-1">
                ...
                <p class="text-sm text-yellow-700 bg-yellow-50 p-2 rounded">{{ lied.rueckfrageAutor }}</p>
            </div>
        </CardContent>
    </Card>
</template>
...
import { Info, ExternalLink, Cloud, AlertTriangle, FileText, Music } from "lucide-vue-next";
