<template>
    <Card class="hover:shadow-lg transition-all duration-200 cursor-pointer group" @click="$emit('click', lied.id)">
        ...
        <CardContent class="space-y-3 flex-1">
            ...
            <div v-if="authors.length > 0" class="space-y-1">
                <p class="text-xs font-medium text-muted-foreground uppercase tracking-wide">Authors</p>
            ...
            <div v-if="fileInfo.length > 0" class="space-y-1">
                <p class="text-xs font-medium text-muted-foreground uppercase tracking-wide">Files</p>
                <div class="flex flex-wrap gap-1">
        ...
        <CardFooter class="pt-3 border-t">
            <div class="flex justify-between items-center w-full">
                ...
                <div class="flex items-center text-xs text-muted-foreground group-hover:text-primary transition-colors">
                    View Details
