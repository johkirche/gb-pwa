    ...
    <Card>
        ...
        <CardContent>
            ...
            <div v-else class="space-y-4">
                <div
v-for="service in history" :key="service.id"
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center space-x-2 text-sm">
                                    ...
                                    <span class="font-medium">{{ service.firstSong?.titel || t('utils.unknown')
                                        }}</span>
                                    <span class="text-muted-foreground">
                                        ({{ t('churchService.verses') }}: {{ service.firstSongVerses.join(', ') }})
                                    </span>
                                    <Badge v-if="hasAudioFiles(service.firstSong)" variant="secondary" class="text-xs">
                                        🎵
                                    </Badge>
                                </div>
                                ...
                                <div class="flex items-center space-x-2 text-sm">
                                    ...
                                    <span class="font-medium">{{ service.secondSong?.titel || t('utils.unknown')
                                        }}</span>
                                    <span class="text-muted-foreground">
                                        ({{ t('churchService.verses') }}: {{ service.secondSongVerses.join(', ') }})
                                    </span>
                                    <Badge v-if="hasAudioFiles(service.secondSong)" variant="secondary" class="text-xs">
                                        🎵
                                    </Badge>
                                </div>
                            </div>
